...
export default function Login() {
  ...
  async function onSubmit(e) {
    ...
    try { await login(email.trim(), password); navigate('/'); } catch (err) { setError(err.message); setBusy(false); }
  }
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <h1>Log in</h1>
        <p className="auth-desc">Your mark schemes and scripts are waiting.</p>
